  ...
  function srcAppServicesProjectsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProjectService = /*#__PURE__*/function () {
      ...
      _createClass(ProjectService, [{
        key: "getProjects",
        value: function getProjects(userId) {
          return this.http.get(_apiConstants__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].GETPROJECTS(userId));
        }
      }, {
        key: "postProject",
        value: function postProject(userId, project) {
          console.log("project", project);
          return this.http.post(_apiConstants__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].ADDPROJECT(userId), project);
        }
      }, {
        key: "payStaff",
        value: function payStaff(userId, project, staff) {
          return this.http.post(_apiConstants__WEBPACK_IMPORTED_MODULE_3__["CONSTANTS"].PAYSTAFF(userId), {
            project: project,
            staff: staff
          });
        }
    ...
    ProjectService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], ProjectService);
    /***/
  }
}]);
