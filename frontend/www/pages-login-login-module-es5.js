...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
  ...
  function srcAppPagesLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(loginService, formBuilder, router) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 4:
                    ...
                    this.loading = true;
                    _context.next = 8;
                    return this.loginService.login(this.user.value).subscribe(function (data) {
                      console.log("user", data);
                      if (data) _this.router.navigate(["/user/" + data._id + "/projects"]);
                    }, function (err) {
                      console.log(err);
                      _this.loading = false;
                    });
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_login_service__WEBPACK_IMPORTED_MODULE_2__["LoginService"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], LoginPage);
    /***/
  }
}]);
