...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-setting-setting-module"], {
  ...
  function srcAppPagesSettingSettingPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SettingPage = /*#__PURE__*/function () {
      function SettingPage(userService, formBuilder) {
        _classCallCheck(this, SettingPage);

        this.userService = userService;
        this.formBuilder = formBuilder; // logged in user
      ...
      _createClass(SettingPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.userService.getUser(this.currentUser).subscribe(function (userItem) {
            ...
            _this.user = userItem.data.profile;
          });
        }
      }, {
        key: "updateUser",
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 3:
                    ...
                    _context.next = 6;
                    return this.userService.updateUser(this.userForm.value, this.currentUser).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["first"])()).subscribe(function (data) {// console.log("user", data);
                    }, function (err) {
                      console.log(err);
                    });
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"]])], SettingPage);
    /***/
  }
}]);
